...
// Assuming you have CalenderCubit and CalenderModel defined somewhere

class caln extends StatefulWidget {
  const caln({Key? key}) : super(key: key);

  @override
  State<caln> createState() => _BodycalenderState();
}

class _BodycalenderState extends State<caln> {
  late DateTime focusedDay;
  late DateTime selectedDay;
  ValueNotifier<DateTime> selectedDayNotifier =
